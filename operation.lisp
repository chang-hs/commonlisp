...
(defun make-instance-of-op-from-id (op-id)
  (multiple-value-bind
        (op-id patient-id kanji-name kana-name birthdate sex
               zip-code address op-date start-time end-time
